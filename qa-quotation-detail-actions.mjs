...
try {
  ...
  await page.locator('.MuiDrawer-root:visible nav [role="button"]').filter({ hasText: "Quotations" }).click();
  ...
  const deleteAction = page.getByRole("menuitem", { name: "Delete quotation", exact: true });
